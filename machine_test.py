...
def test_TextMachineClass():
    ...
    # A new text machine starts with two texts1 type.
    tm1 = TextMachine((75, 125), (25, 245))
    assert (str(tm1) == "Text Machine:<75 texts1; ₴1.25 each>; "
                        "<25 texts1; ₴2.45 each>")
    ...
    assert tm1.still_owe() == (125, 245)
    assert (str(tm1) == "Text Machine:<74 texts1; ₴1.25 each>; "
                        "<25 texts1; ₴2.45 each>")
    ...
    tma = TextMachine.airport_machine()
    assert (str(tma) == "Text Machine:<200 texts1; ₴2.25 each>; "
                        "<200 texts1; ₴3.45 each>")

    # Machines can become empty
    tm2 = TextMachine((1, 120), (0, 245))
    assert str(tm2) == "Text Machine:<1 texts1; ₴1.20 each>"
    ...
    assert str(tm2) == "Text Machine:<0 texts1; ₴1.20 each>"
    ...
    assert tm2.is_empty() == False
    assert (str(tm2) == "Text Machine:<20 texts1; ₴1.20 each>; "
                        "<20 texts1; ₴2.45 each>")
